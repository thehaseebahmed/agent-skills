---
name: valid-skill
description: Demonstrates a SKILL.md that satisfies every lint rule. Use when checking the linter itself, or as a reference for the required shape.
---
...
See the [shared checklist](../references/does-not-exist.md).
